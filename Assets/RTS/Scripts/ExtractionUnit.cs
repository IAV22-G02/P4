...
{
    /* 
     * Las unidades de extracciÛn sirven para obtener los recursos del escenario, no son capaces de atacar pero sÅEreciben daÒo.
     */ 
    public class ExtractionUnit : Unit
    {
        ...
        // La unidad extractora intentarÅEextraer los recursos del campos m·s cercano a la posiciÛn dada. 
        // Posibles mejoras:
        ...
        // - Considerar si es interesante que haya una variable en la unidad para saber a quÅEinstalaciÛn de procesamiento estÅE'asociada'.
